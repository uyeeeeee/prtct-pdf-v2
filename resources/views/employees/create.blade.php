                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('employees.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="position" id="position" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                        </div>
                        
                        <div class="mb-4">
                            <label for="work_start_time" class="block text-gray-700 text-sm font-bold mb-2">Work Start Time:</label>
                            <input type="time" name="work_start_time" id="work_start_time" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                        </div>

                        <div class="mb-4">
                            <label for="work_end_time" class="block text-gray-700 text-sm font-bold mb-2">Work End Time:</label>
                            <input type="time" name="work_end_time" id="work_end_time" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                        </div>

                        <div class="mb-4">
                            <label for="grace_period_minutes" class="block text-gray-700 text-sm font-bold mb-2">Grace Period (minutes):</label>
                            <input type="number" name="grace_period_minutes" id="grace_period_minutes" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="15" required>
                        </div>
